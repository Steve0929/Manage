...
const proyectSchema = new Schema({
    ...
    milestones: [{milestone: String, completado: Boolean, horas: Number , actividades: [{actividad: String, horas: Number, completado: Boolean, timeStamp: Date, asignadoA: String}]}],
