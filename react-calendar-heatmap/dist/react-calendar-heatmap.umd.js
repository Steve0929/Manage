(function (global, factory) {
  ...
  var DAYS_IN_WEEK = 7;
  var MONTH_LABELS = ['Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  ...
  function (_React$Component) {
    ...
    function CalendarHeatmap() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getValueCache", index(function (props) {
        return props.values.reduce(function (memo, value) {
          var date = convertToDate(value.date);
          var index$$1 = Math.floor((date - _this.getStartDateWithEmptyDays()) / MILLISECONDS_IN_ONE_DAY); // eslint-disable-next-line no-param-reassign
    ...
    _createClass(CalendarHeatmap, [{
      ...
      value: function getValueForIndex(index$$1) {
        if (this.valueCache[index$$1]) {
          return this.valueCache[index$$1].value;
        }
      ...
      value: function getClassNameForIndex(index$$1) {
        if (this.valueCache[index$$1]) {
          return this.valueCache[index$$1].className;
        }
      ...
      value: function getTitleForIndex(index$$1) {
        if (this.valueCache[index$$1]) {
          return this.valueCache[index$$1].title;
        }
      ...
      value: function getTooltipDataAttrsForIndex(index$$1) {
        if (this.valueCache[index$$1]) {
          return this.valueCache[index$$1].tooltipDataAttrs;
        }
      ...
      value: function getViewBox() {
        if (this.props.horizontal) {
          return "0 0 ".concat(this.getWidth(), " ").concat(this.getHeight()-25);
        }
      ...
      key: "renderSquare",
      value: function renderSquare(dayIndex, index$$1) {
        var _this2 = this;

        var indexOutOfRange = index$$1 < this.getNumEmptyDaysAtStart() || index$$1 >= this.getNumEmptyDaysAtStart() + this.getDateDifferenceInDays();
        ...
        var value = this.getValueForIndex(index$$1);
        ...
        React.createElement("rect", _extends({
          ...
          x: x,
          y: y,
          className: this.getClassNameForIndex(index$$1),
        ...
        }, this.getTooltipDataAttrsForIndex(index$$1)), React.createElement("title", null, this.getTitleForIndex(index$$1)));
        var transformDayElement = this.props.transformDayElement;
        return transformDayElement ? transformDayElement(rect, value, index$$1) : rect;
      }
    }, {
      key: "renderWeek",
      ...
      value: function renderWeekdayLabels() {
        ...
        return this.props.weekdayLabels.map(function (weekdayLabel, dayIndex) {
          ...
          var tt= true;
          return true || dayIndex & 1 ? React.createElement("text", {
  ...
  CalendarHeatmap.propTypes = {
    ...
    showAllWeekdayLabels: propTypes.bool
